-- =================================================================
-- get_horarios_disponiveis -> versao de 5 argumentos com p_duracao_total
-- Suporta multiplos servicos (soma das duracoes). SECURITY DEFINER.
...
BEGIN
  ...
  -- Usa duracao total informada (multiplos servicos) ou cai para o servico principal
